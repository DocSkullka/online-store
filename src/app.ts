...
export function slider() {
    for (let i:number = 0; i <= item.products.length - 1; i++) {
            ...
            document.querySelector('.addItem').id = `${i}`
...
document.addEventListener('click', countCart)
